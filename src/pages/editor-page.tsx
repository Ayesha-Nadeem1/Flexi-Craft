...
useEffect(() => {
  ...
  const updateContent = () => {
      ...
      const modelContent = ecRef.current?.innerHTML.trim() || "";

      // Check if both editor content and model content are empty
      if (!editorContent && !modelContent) {
          setCombinedContent(`
              <div style="text-align: center; color: red; font-weight: bold;">
                  Please add content to either the editor or model before hosting.
              </div>
          `);
      } else {
          setCombinedContent(`
  ...
  `;
    ...
    const exportHTMLFile = () => {
      ...
      a.href = url;
      a.download = "flexicraft-website.html";
      a.click();
            ...
            <EditorProvider>
                ...
                {!livemode && (
                      ...
                      <button 
                        ...
                        className="absolute top-6 right-140 bg-blue-500 text-white px-4 py-2 rounded-md "
                      >
                        ⬇️Export Websit Export HTML
                      </button>
